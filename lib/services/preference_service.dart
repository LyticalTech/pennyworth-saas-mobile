...
class AppPreferences {
  ...
  void setInt(String key, int value, {bool prefix = false}) {
  ...
  void setBool(String key, bool value, {bool prefix = false}) {
  ...
  void setString(String key, String value, {bool prefix = false}) {
  ...
  void setStringList(String key, List<String> value, {bool prefix = false}) {
    _preferences.setStringList(_key(key, prefix), value);
  }

  void remove(String key, {bool prefix = false}) {
